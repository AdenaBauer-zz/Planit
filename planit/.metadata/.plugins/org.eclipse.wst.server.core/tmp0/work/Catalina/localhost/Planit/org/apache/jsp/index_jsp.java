 ...
 * Generated at: 2015-11-22 23:17:06 UTC
...
return;
    ...
    try {
      ...
      out.write("            \t};\n");
      out.write("            \t\n");
      out.write("            \tvar posting = $.post( 'http://localhost:8080/Planit/addOrganization', JSON.stringify(orgdata), function(data, status){\n");
      out.write("\t\t\t\t\tconsole.log(data);\n");
      out.write("\t\t\t  \t\t$('#sidebar').append(\"<div id='\" + data.substr(0, data.length-1) + \"' class='organization'>\" + $('#org-name-input').val() + \"</div>\");\n");
      out.write("\t\t\t\t  \t\n");
      out.write("            \t});\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("\t\t\t\t  \t\n");
      out.write("\t\t\t\t  \t\n");
      out.write("\t\t\t\t  \t//var idpost = $.post('http://localhost:8080/Planit/clickOrganization', id);\n");
      out.write("\t\t\t\t}); */\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\n");
      out.write("            }\n");
      out.write("          }\n");
      out.write("\t\t\t\n");
      out.write("          function getOrganizations() {\n");
      out.write("        \t  $.get(\"http://localhost:8080/Planit/getOrganization\", function(data){\n");
      out.write("        \t\t  var orgs = JSON.parse(data).organizations;\n");
      out.write("        \t\t  console.log(orgs);\n");
      out.write("        \t\t  for(org in orgs){\n");
      out.write("        \t\t\t  $(\"#organizations\").append(\n");
      out.write("           \t\t\t\t  \"<div id='\" + orgs[org].idOrganization + \"' class='organization'>\" +\n");
      out.write("                              orgs[org].nameOrganization + \n");
      out.write("                          \"</div>\"  \n");
      out.write("            \t\t  );\n");
      out.write("        \t\t  }\n");
      out.write("        \t\t  \n");
